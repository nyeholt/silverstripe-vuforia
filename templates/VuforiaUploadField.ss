...
<% require css('vuforia/css/vuforia-field-cms.css') %>
		...
		<% loop $CustomisedItems %>
			<li class="ss-uploadfield-item template-download" data-fileid="$ID">
				...
				<div class="ss-uploadfield-item-info">
					...
					<div class="vuforia-item-details">
						<div class='vuforia-status'>
							<label>Status: </label> <span>$ProcessStatus</span> 
							</div>
						
						<% if $ProcessStatus == 'complete' %>
							<% with $VuforiaInfo.target_record %>
							
							<div class='vuforia-field'>
							<label>Target ID:</label> <span>$target_id</span> 
							</div>
							<div class='vuforia-field'>
							...
							<div class='vuforia-field'>
							<label>Tracking Rating:</label> <span>$tracking_rating</span> 
							</div>
							<div class='vuforia-field'>
							<label>Reco Rating:</label> <span>$reco_rating</span> 
							</div>
							<% end_with %>
						<% else %>
							<span class='message $ProcessStatus'>$Messages</span>
						<% end_if %>
